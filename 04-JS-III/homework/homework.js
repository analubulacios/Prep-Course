...
function numeroMasGrande(numeros) {
  ...
  // Tu código:
  var valorinicial=numeros[0]
  for (var i=1;i<numeros.length;i++) {
  if (numeros[i]> valorinicial) valorinicial=numeros[i]};
  return valorinicial; 
}
...
function empiezaConNueve(n) {
  ...
  //Escribe tu código aquí
  var denumastring= n.toString()
  if (denumastring.charAt(0)==='9') return true; //TEC! para indicar la posicion 0 puedo hacer como en los arrays denumastring[0]
  return false;
}
...
function breakStatement(numero) {
 ...
 if (i<10) return "Se interrumpió la ejecución" // significa que el bucle no llego a 10 vueltas es porque se cumple la condicion del break. 
 return array;
}
